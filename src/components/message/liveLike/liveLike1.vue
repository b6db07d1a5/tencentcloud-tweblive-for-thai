  ...
  methods: {
    ...
    likeClick() {
      ...
      const anmationData = {
        ...
        pathData: this.generatePathData(), // path
        image: img,
        factor: {
          speed: 0.01, // Movement speed, the smaller the value, the slower
    ...
    /**Get the integer of the random value before the maximum and minimum */
